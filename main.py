...
part_neg = pd.read_csv(input_dir + '/partitioned_data/soma_currents/soma_neg_0.csv')
part_pos = pd.read_csv(input_dir + '/partitioned_data/soma_currents/soma_pos_0.csv')
